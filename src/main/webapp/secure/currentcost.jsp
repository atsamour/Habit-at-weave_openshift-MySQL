...
<head>
    ...
    <title>Habitatweave: Current Cost plugs </title>
    ...
    <script type="text/javascript">
        ...
        //$(document).ready(function() { responsiveVoice.speak($('#text').val(),$('#voiceselection').val()); });
    </script>
            ...
            <ul class="nav navbar-nav side-nav">
                ...
                <li class="active">
                    ...
                    <ul id="home" class="collapse in" aria-expanded="true">
                        ...
                        <li>
                            <a href="currentcost" class="active"><i class="fa fa-fw fa-leaf"></i> Current Cost</a>
                        </li>
                        <li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <i class="fa fa-leaf"></i> Current Cost
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-leaf"></i> Current Cost Appliances</h3>
                        </div>
                        <div class="panel-body">
                                ...
                                <table class="table table-bordered table-hover table-striped">
                                    ...
                                    <c:forEach var="current" items="${sensorIDs}" varStatus="loopCount">
                                        <tr <c:if test="${current eq sensor}">class="warning"</c:if>>
                                            ...
                                            <td>${sensors[loopCount.count - 1].vendorname}</td>
                                            <td>${sensors[loopCount.count - 1].description}</td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
